\begin{figure}[!h]
  ...
  \begin{tikzpicture}
    ...
    \node             (arrow) [right=of lefta] {$\underset{\pi_{11}}{\to}$};
    ...
    \node[vertex]     (lefta) [label=1] {};
    \node[hyperedge]  (hyp1)  [below=0.5cm of lefta] {A};
    \node             (arrow) [right=of lefta] {$\underset{\pi_{12}}{\to}$};
    \node[vertex]     (a)     [right=of arrow,label=1] {};
    ...
    \node[vertex]     (lefta) [label=1] {};
    \node[hyperedge]  (hyp1)  [below=0.5cm of lefta] {A};
    \node             (arrow) [right=of lefta] {$\underset{\pi_{13}}{\to}$};
    \node[vertex]     (a)     [right=of arrow,label=1] {};
  ...
  \end{tikzpicture}
  \caption{An ambigous grammar}
  \label{fig:ambiguousGrammar}
